...
use type \{XHPChild, JsonSerializable, XHPUnsafeRenderable};
...
abstract class :xhp implements XHPChild, JsonSerializable {
	...
	public function __construct(KeyedTraversable<string, mixed> $attributes, Traversable<XHPChild> $children): void {
	}
	...
	protected static function __xhpAttributeDeclaration(): darray<string, darray<int, mixed>> {
		return darray[];
	}
