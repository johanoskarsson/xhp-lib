...
use type \XHP\XHPClassException;

/**
 * Subclasses of :raw-pcdata-element must contain only \Stringish children.
 ...
 * the element."
 */
abstract class :raw-pcdata-element extends :pcdata-element {
